...
namespace Universal_x86_Tuning_Utility.Scripts.Misc
{
    class GetImages
    {
        public static async Task<string> GetIconImageUrl(string gameName)
        {
            try
            {
                string path = string.IsNullOrEmpty(Universal_x86_Tuning_Utility.Properties.Settings.Default.Path) ? AppContext.BaseDirectory : Universal_x86_Tuning_Utility.Properties.Settings.Default.Path;
