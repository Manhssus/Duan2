...
namespace Universal_x86_Tuning_Utility.Views.Pages
{
    ...
    public partial class Games : INavigableView<ViewModels.GamesViewModel>
    {
        ...
        private static GameDataManager gameDataManager = new GameDataManager(Path.Combine(string.IsNullOrEmpty(Settings.Default.Path) ? AppContext.BaseDirectory : Settings.Default.Path, "gameData.json"));
