...
namespace Universal_x86_Tuning_Utility
{
    ...
    public partial class App
    {
        ...
        private Mutex mutex;
        private const string MutexName = "VeloXUtility_v26_2";

        public static readonly string SCALE_MODELS_JSON_PATH = System.IO.Path.Combine(System.AppContext.BaseDirectory, "ScaleModels.json");
        public static readonly string LOGS_FOLDER = System.IO.Path.Combine(System.AppContext.BaseDirectory, "logs") + "\\";
        ...
        private async void OnStartup(object sender, StartupEventArgs e)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.File(LOGS_FOLDER + "velox_log.txt",
